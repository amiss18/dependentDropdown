 ...
 */
final class Version20190927143446 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contact (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, commune_id BIGINT NOT NULL, nom VARCHAR(50) NOT NULL, tel VARCHAR(20) NOT NULL)');
        $this->addSql('CREATE INDEX IDX_4C62E638131A4F72 ON contact (commune_id)');
