 ...
 */
final class Version20190927111656 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE departement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, region_id INTEGER NOT NULL, code VARCHAR(3) NOT NULL COLLATE BINARY, code_region VARCHAR(2) NOT NULL COLLATE BINARY, nom VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_C1765B6398260155 FOREIGN KEY (region_id) REFERENCES departement (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
